...
public class MainActivity extends AppCompatActivity implements
    ...
    public void onAddPlaceButtonClicked(View view) {
        ...
        try {
            ...
            // If the device doesn't have Play Services, the above line will cause the app to crash
            // This is why bellow, you need to catch the exceptions and prompt user to take action -
            // .. install/update google Play Services in order to continue (right now it's just logging).
